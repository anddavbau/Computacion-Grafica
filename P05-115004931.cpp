...
int main()
{
	...
	while (!mainWindow.getShouldClose())
	{
		...
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, mainWindow.getarticulacion2()*0.02f));//Ir adelante
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, -mainWindow.getarticulacion3()*0.02f));//Ir atras
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		model = glm::rotate(model, glm::radians(fmod(mainWindow.getarticulacion1(),45.0f)), glm::vec3(-1.0f, 0.0f, 0.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion2()), glm::vec3(1.0f,0.0f,0.0f));//Ir adelante
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion3()), glm::vec3(-1.0f,0.0f,0.0f));//Ir atras
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
