...
int main()
{
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//Caras piramides rojas
		color = glm::vec3(1.0f, 0.0f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		//Triangulos apuntando hacia arriba
		//Baja
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f, -0.35f, 0.43f));
		...
		//
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.3f, -0.35f, 0.43f));
		model = glm::rotate(model,glm::radians(-25.0f),glm::vec3(1.0f,0.0f,0.0f));
		model = glm::scale(model, glm::vec3(0.25f, 0.25f, 0.01f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		meshList[1]->RenderMesh();
		...
		//Intermedio
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.15f, -0.1f, 0.30f));
		model = glm::rotate(model,glm::radians(-25.0f),glm::vec3(1.0f,0.0f,0.0f));
		model = glm::scale(model, glm::vec3(0.25f, 0.25f, 0.01f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		meshList[1]->RenderMesh();
		...
		//Alto
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f, 0.17f, 0.17f));
		model = glm::rotate(model,glm::radians(-25.0f),glm::vec3(1.0f,0.0f,0.0f));
		model = glm::scale(model, glm::vec3(0.25f, 0.25f, 0.01f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		meshList[1]->RenderMesh();
		...
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.15f, -0.35f, 0.43f));
		model = glm::rotate(model,glm::radians(-25.0f+180.0f),glm::vec3(1.0f,0.0f,0.0f));
		model = glm::scale(model, glm::vec3(0.25f, 0.25f, 0.01f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		meshList[1]->RenderMesh();
		//
		...
		//
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f, -0.1f, 0.31f));
		model = glm::rotate(model,glm::radians(-25.0f+180.0f),glm::vec3(1.0f,0.0f,0.0f));
		model = glm::scale(model, glm::vec3(0.25f, 0.25f, 0.01f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		meshList[1]->RenderMesh();

		//Caras piramides azul
		color = glm::vec3(0.0f, 0.0f, 1.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		//Bajo
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f, -0.5f, 0.33f));
		model = glm::scale(model, glm::vec3(0.25f, 0.01f, 0.25f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		meshList[1]->RenderMesh();
		//
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.3f, -0.5f, 0.33f));
		model = glm::scale(model, glm::vec3(0.25f, 0.01f, 0.25f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		meshList[1]->RenderMesh();
		//
		...
		//Medio
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.15f, -0.5f, 0.06f));
		model = glm::scale(model, glm::vec3(0.25f, 0.01f, 0.25f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		meshList[1]->RenderMesh();
		//
		...
		//Triangulos apuntando hacia abajo
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.15f, -0.51f, 0.33f));
		...
		//
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f, -0.51f, 0.06f));
		model = glm::rotate(model,glm::radians(180.0f),glm::vec3(1.0f,0.0f,0.0f));
		model = glm::scale(model, glm::vec3(0.25f, 0.01f, 0.25f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		meshList[1]->RenderMesh();

		//Caras piramides verde
		color = glm::vec3(0.0f, 1.0f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		//Abajo
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.07f, -0.35f, -0.30f));
		model = glm::rotate(model,glm::radians(90.0f+27.0f),glm::vec3(-0.0f,1.0f,0.0f));
		...
		//
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.19f, -0.35f, -0.06f));
		model = glm::rotate(model,glm::radians(90.0f+27.0f),glm::vec3(-0.0f,1.0f,0.0f));
		model = glm::rotate(model,glm::radians(10.0f),glm::vec3(-1.0f,0.0f,0.0f));
		model = glm::scale(model, glm::vec3(0.25f, 0.25f, 0.01f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.32f, -0.35f, 0.18f));
		model = glm::rotate(model,glm::radians(90.0f+27.0f),glm::vec3(-0.0f,1.0f,0.0f));
		model = glm::rotate(model,glm::radians(10.0f),glm::vec3(-1.0f,0.0f,0.0f));
		model = glm::scale(model, glm::vec3(0.25f, 0.25f, 0.01f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//Medio
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.08f, -0.1f, -0.16f));
		model = glm::rotate(model,glm::radians(90.0f+27.0f),glm::vec3(-0.0f,1.0f,0.0f));
		model = glm::rotate(model,glm::radians(10.0f),glm::vec3(-1.0f,0.0f,0.0f));
		model = glm::scale(model, glm::vec3(0.25f, 0.25f, 0.01f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.20f, -0.1f, 0.08f));
		model = glm::rotate(model,glm::radians(90.0f+27.0f),glm::vec3(-0.0f,1.0f,0.0f));
		model = glm::rotate(model,glm::radians(10.0f),glm::vec3(-1.0f,0.0f,0.0f));
		model = glm::scale(model, glm::vec3(0.25f, 0.25f, 0.01f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//Arriba
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.09f, 0.17f, -0.01f));
		model = glm::rotate(model,glm::radians(90.0f+27.0f),glm::vec3(-0.0f,1.0f,0.0f));
		model = glm::rotate(model,glm::radians(10.0f),glm::vec3(-1.0f,0.0f,0.0f));
		model = glm::scale(model, glm::vec3(0.25f, 0.25f, 0.01f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//Triangulos apuntando hacia abajo
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.13f, -0.35f, -0.18f));
		model = glm::rotate(model,glm::radians(90.0f+27.0f),glm::vec3(-0.0f,1.0f,0.0f));
		model = glm::rotate(model,glm::radians(10.0f+180.0f),glm::vec3(-1.0f,0.0f,0.0f));
		model = glm::scale(model, glm::vec3(0.25f, 0.25f, 0.01f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		meshList[1]->RenderMesh();
		//
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.25f, -0.35f, 0.06f));
		model = glm::rotate(model,glm::radians(90.0f+27.0f),glm::vec3(-0.0f,1.0f,0.0f));
		model = glm::rotate(model,glm::radians(10.0f+180.0f),glm::vec3(-1.0f,0.0f,0.0f));
		model = glm::scale(model, glm::vec3(0.25f, 0.25f, 0.01f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.14f, -0.1f, -0.04f));
		model = glm::rotate(model,glm::radians(90.0f+27.0f),glm::vec3(-0.0f,1.0f,0.0f));
		model = glm::rotate(model,glm::radians(10.0f+180.0f),glm::vec3(-1.0f,0.0f,0.0f));
		model = glm::scale(model, glm::vec3(0.25f, 0.25f, 0.01f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
