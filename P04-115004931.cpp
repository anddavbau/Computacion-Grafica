...
int main()
{
	...
	*/
	...
	glm::mat4 modelrestore(1.0);//Matriz para recuperar el primer punto
	...
	while (!mainWindow.getShouldClose())
	{
		...
		modelaux = model;
		modelrestore = model;//Variable para recuperar este punto para adjuntar base y llantas del vehiculo
		...
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		model = glm::translate(model,glm::vec3(0.0f,-1.0f,0.0f));
		modelaux = model; //Para descartar la escala
		model = glm::scale(model,glm::vec3(4.0f,1.5f,4.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		model = glm::rotate(model,mainWindow.getarticulacion5(),glm::vec3(0.0f,1.0f,0.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		meshList[2]->RenderMeshGeometry();
		//2
		model = modelaux;
		model = glm::translate(model,glm::vec3(2.0f,-4.0f,0.0f));
		model = glm::rotate(model,mainWindow.getarticulacion6(),glm::vec3(0.0f,1.0f,0.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		meshList[2]->RenderMeshGeometry();
		//3
		model = modelaux;
		model = glm::translate(model,glm::vec3(-2.0f,4.0f,0.0f));
		model = glm::rotate(model,mainWindow.getarticulacion7(),glm::vec3(0.0f,1.0f,0.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		meshList[2]->RenderMeshGeometry();
		//4
		model = modelaux;
		model = glm::translate(model,glm::vec3(-2.0f,-4.0f,0.0f));
		model = glm::rotate(model,mainWindow.getarticulacion8(),glm::vec3(0.0f,1.0f,0.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		meshList[2]->RenderMeshGeometry();
		...
		//Creación del gato
		//La contrucción se define como cada pata es articulada por 2 partes y podra mover la cola y orejas
		//Cuerpo
		model = glm::mat4(1.0f);
		color = glm::vec3(0.9f,0.9f,0.9f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		model = glm::translate(model,glm::vec3(0.0f,0.0f,4.0f));
		modelrestore = model;//Para recuperar posición del cuerpo y escalas por defecto.
		...
		modelaux = model;
		model = glm::scale(model,glm::vec3(1.0f,0.2f,0.8f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		meshList[0]->RenderMesh();
		//2
		//Base de la pata
		...
		model = glm::rotate(model,glm::radians(-90.0f+15.0f),glm::vec3(0.0f,0.0f,1.0f));
		model = glm::translate(model,glm::vec3(0.0f,1.25f,0.0f));
		modelaux = model;
		model = glm::scale(model,glm::vec3(0.25,2.0f,0.25));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		meshList[2]->RenderMeshGeometry();
		...
		model = glm::translate(model,glm::vec3(0.0f,1.0f,0.0f));
		modelaux = model;
		model = glm::scale(model,glm::vec3(0.25,1.5f,0.25));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		meshList[2]->RenderMeshGeometry();
		//Base de Cabeza
		model = modelrestore;
		...
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		sp.render();
		//Visor del gato robot
		modelaux = model;
		color = glm::vec3(0.1f,0.1f,0.1f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		model = glm::translate(model,glm::vec3(-0.75f,0.25f,0.0f));
		model = glm::scale(model,glm::vec3(0.5f,0.5f,1.25f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		meshList[0]->RenderMesh();
		//Orejas del gato
		model = modelaux;
